    ...
    <body>
        <div class="container">
            ...
            <div class="route-list">
                ...
                <div class="route-item">
                    <div>
                        <span class="url" style="cursor: default;">/bookings</span>
                        <div class="desc">Submits new session reservations securely from frontend forms</div>
                    </div>
                    <span class="method post">POST</span>
                </div>
            </div>
...
app.get("/bookings", async (req, res) => {
  try {
    ...
    // Find all documents inside the bookings collection and convert to an array
